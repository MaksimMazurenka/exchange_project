...
import com.example.finalproject.activity.market.ProductWithDeals;
...
public class GoodOffer extends AppCompatActivity {
    SQLiteDatabase db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.good_offer);
        ...
        recyclerView.addOnItemTouchListener(
            new RecyclerItemClickListener(GoodOffer.this, recyclerView ,new RecyclerItemClickListener.OnItemClickListener() {
                @Override public void onItemClick(View view, int position) {
                    ...
                    System.gc();
                    Intent intent2 = new Intent(GoodOffer.this, ProductWithDeals.class);
    ...
    public void Back(View view){
        ...
        {
            Intent intent2 = new Intent(GoodOffer.this, MainWindow.class);
            startActivity(intent2);
        }else{
            if(pos==-2){
                Intent intent2 = new Intent(GoodOffer.this, MainWindow.class);
    ...
    public void onInit() throws Exception {
        ...
        if(user.getIduser()==000){
            ...
            if(selectedId==-1 && pos==-1){
                ...
                mAdapter=new RecyclerViewAdapter(products,GoodOffer.this);
                ...
                if(pos==-2){
                    ...
                    layoutManager = new LinearLayoutManager(this);
                    recyclerView.setLayoutManager(layoutManager);
                    mAdapter=new RecyclerViewAdapter(productsWithDeals,GoodOffer.this);
                    recyclerView.setAdapter(mAdapter);
                }else {
                    Product product = database.getProduct(selectedId);
                    offer = product.getOffers().get(pos);
    ...
    public void Confirm(View view) throws SocketException {
        Database database = new Database(db);
        database.goodOffer(selectedId,offer,products);
        Intent intent2 = new Intent(GoodOffer.this, MainWindow.class);
        startActivity(intent2);
    }
}